import { ShoppingBag, Play, Sparkles, CheckCircle } from "lucide-react";
    ...
    <section id="projects" style={{ padding: "100px 0", position: "relative" }}>
      <div className="container">
        ...
        <div className="section-header">
          ...
          >
            Interactive applications built with React.js, Next.js, and Zustand
            state management. Click "Launch Interactive Demo" to test live
